 ...
 *
 * <p>
 * PlatformAgent is a singleton agent accessible as 'gama' in GAML models. It provides access to platform-level
 * information and capabilities such as:
 * <ul>
 ...
 *
 * <p>
 * The platform agent exposes several read-only attributes:
 * </p>
 * <ul>
 ...
 *
 * <p>
 * The platform agent automatically monitors memory usage if configured in preferences. When memory runs low, it emits
 * warnings to help prevent out-of-memory errors.
 * </p>
 *
